...
const Signup = () => {
  ...
  const { signup, loading, error, token, setError } = useAuth()
    ...
    <div className="flex min-h-screen items-center justify-center bg-gradient-to-br from-blue-50 via-white to-indigo-50 px-4 py-10">
      <div className="w-full max-w-md rounded-3xl bg-white p-8 shadow-2xl">
        <div className="mb-8 text-center">
          ...
          <p className="mt-3 text-sm text-slate-600">Join thousands tracking weather worldwide</p>
        </div>
        ...
        <p className="mt-6 text-center text-sm text-slate-600">
          <Link className="font-semibold text-blue-600 hover:text-blue-700 transition" to="/login">
            Login here
          </Link>
        </p>
      </div>
